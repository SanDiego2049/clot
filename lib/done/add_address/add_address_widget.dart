                            ...
                            child: Container(
                              ...
                              child: Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    12.0, 0.0, 8.0, 0.0),
                                child: TextFormField(
                                  controller: _model.addresTextController1,
                                  focusNode: _model.addresFocusNode1,
                                  autofocus: true,
                                  obscureText: false,
                                  ...
                                  validator: _model
                                      .addresTextController1Validator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.zipcodeTextController1,
                                          focusNode: _model.zipcodeFocusNode1,
                                          autofocus: true,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            labelText: 'Zip code',
                          ...
                          await AddressRecord.collection
                              ...
                              .set(createAddressRecordData(
                                ...
                                zipcode: int.tryParse(
                                    _model.zipcodeTextController1.text),
                                state: _model.stateTextController1.text,
                              ));
                          FFAppState().address =
                              '${_model.addresTextController1.text} ${_model.cityTextController1.text} ${_model.stateTextController1.text}';
                          safeSetState(() {});
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    12.0, 0.0, 8.0, 0.0),
                                child: TextFormField(
                                  controller: _model.addresTextController2,
                                  focusNode: _model.addresFocusNode2,
                                  autofocus: true,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    labelText: 'Street name',
                                  ...
                                  validator: _model
                                      .addresTextController2Validator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.zipcodeTextController2,
                                          focusNode: _model.zipcodeFocusNode2,
                                          autofocus: true,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            labelText: 'Zip code',
                        ...
                        onTap: () async {
                          await AddressRecord.collection
                              ...
                              .set(createAddressRecordData(
                                ...
                                zipcode: int.tryParse(
                                    _model.zipcodeTextController2.text),
                                state: _model.stateTextController2.text,
                              ));
                          FFAppState().address =
                              '${_model.addresTextController2.text} ${_model.cityTextController2.text} ${_model.stateTextController2.text}';
                          safeSetState(() {});
                          ScaffoldMessenger.of(context).clearSnackBars();
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
