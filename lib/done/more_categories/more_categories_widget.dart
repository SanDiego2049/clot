...
import 'more_categories_model.dart';
export 'more_categories_model.dart';

class MoreCategoriesWidget extends StatefulWidget {
  const MoreCategoriesWidget({super.key});

  @override
  State<MoreCategoriesWidget> createState() => _MoreCategoriesWidgetState();
}

class _MoreCategoriesWidgetState extends State<MoreCategoriesWidget> {
  late MoreCategoriesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MoreCategoriesModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<int>(
      ...
      builder: (context, snapshot) {
        ...
        int moreCategoriesCount = snapshot.data!;
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                '${FFAppState().categories} (${moreCategoriesCount.toString()})',
