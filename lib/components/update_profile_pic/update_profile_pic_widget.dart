...
import 'update_profile_pic_model.dart';
export 'update_profile_pic_model.dart';
...
class _UpdateProfilePicWidgetState extends State<UpdateProfilePicWidget> {
  late UpdateProfilePicModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateProfilePicModel());
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        final selectedMedia =
                                          ...
                                          maxHeight: 80.00,
                                          allowPhoto: true,
                                          textColor: const Color(0xFF8E6CEF),
                                        );
